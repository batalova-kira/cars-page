...
`,Dt=()=>{const{modalData:t,closeModal:e}=E.useContext(R),{img:o,photoLink:i,description:a,make:s,model:p,year:l,address:c,fuelConsumption:j,engineSize:C,accessories:f,functionalities:m,type:x,id:k,rentalConditions:O,mileage:P,rentalPrice:b}=t,y=c.split(","),M=y[1].trim(),h=y[2].trim(),z=O.split(`
`),W=z[0],D=W.split(":")[0].trim(),N=W.split(":")[1].trim(),F=b.replace("$","");E.useEffect(()=>{const g=H=>{H.code==="Escape"&&e()};return window.addEventListener("keydown",g),document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",g),document.body.style.overflow="auto"}},[e]);const _=g=>{g.target===g.currentTarget&&e()};return n.jsx(gt,{onClick:_,children:n.jsxs("div",{className:"modal",children:[n.jsx(ut,{onClick:e,children:"×"}),n.jsx(xt,{children:n.jsx(bt,{src:o||i,alt:a})}),n.jsxs(yt,{children:[n.jsxs(vt,{children:[s," ",n.jsx(wt,{children:p}),","," ",l]}),n.jsxs(jt,{children:[M," | ",h," | Id: ",k," | Year: ",l," | Type:"," ",x," Fuel Consumption: ",j," | Engine Size: ",C]})]}),n.jsx(Ct,{children:a}),n.jsx(kt,{children:"Accessories and functionalities:"}),n.jsxs(Ot,{children:[f[0]," | ",f[1]," | ",f[2]]}),n.jsxs(Pt,{children:[m[0]," | ",m[1]," |",m[2]]}),n.jsx(Mt,{children:n.jsx(zt,{children:"Rental Conditions:"})}),n.jsxs(It,{children:[n.jsxs(u,{children:[D," : ",n.jsx(I,{children:N})]}),n.jsx(u,{children:z[1]}),n.jsx(u,{children:z[2]}),n.jsxs(u,{children:["Mileage: ",n.jsx(I,{children:P.toLocaleString()})]}),n.jsxs(u,{children:["Price: ",n.jsxs(I,{children:[F,"$"]})]})]}),n.jsx(Et,{href:"tel:+380730000000",children:"Rental car"})]})})};export{Bt as B,At as C,Dt as M,St as a,Lt as b,Rt as c,Wt as s};
