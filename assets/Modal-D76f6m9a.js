...
`,At=({item:t,isFavorite:e})=>{const{openModal:o}=E.useContext(A),i=K(),a=t.address.split(","),s=a[1].trim(),p=a[2].trim(),l=t.accessories.some(m=>m.toLowerCase().includes("premium")),c=t.accessories[0].split(" ").slice(0,2).join(" "),{img:j,photoLink:C,description:f,make:h,model:x,year:k,rentalPrice:O,rentalCompany:P,type:b,id:y}=t,M=m=>{m.preventDefault(),i($(t))};return n.jsxs(tt,{children:[n.jsx(et,{children:n.jsx(ot,{src:j||C,alt:f})}),n.jsx(pt,{type:"button",onClick:M,children:e?n.jsx(ht,{}):n.jsx(ft,{})}),n.jsxs(nt,{children:[n.jsxs(rt,{children:[h," ",n.jsx(it,{children:x}),", ",k]}),n.jsx(at,{children:O})]}),n.jsx(st,{children:n.jsxs(ct,{children:[s," | ",p," | ",P," |",l?" Premium "+b:b," | ",x," |",y," |",c]})}),n.jsx(lt,{children:n.jsx(dt,{type:"button",onClick:()=>o(t),children:"Learn more"})})]})},Bt=r.ul`
    display: flex;
    flex-wrap: wrap;
    row-gap: 50px;
    column-gap: 29px;
...
`;function mt(t){return T({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"m289.94 256 95-95A24 24 0 0 0 351 127l-95 95-95-95a24 24 0 0 0-34 34l95 95-95 95a24 24 0 1 0 34 34l95-95 95 95a24 24 0 0 0 34-34z"},child:[]}]})(t)}const gt=r.div`
    position: fixed;
    top: 0;
    right: 0;
    bottom: 0;
...
`,Nt=()=>{const{modalData:t,closeModal:e}=E.useContext(A),{img:o,photoLink:i,description:a,make:s,model:p,year:l,address:c,fuelConsumption:j,engineSize:C,accessories:f,functionalities:h,type:x,id:k,rentalConditions:O,mileage:P,rentalPrice:b}=t,y=c.split(","),M=y[1].trim(),m=y[2].trim(),z=O.split(`
`),W=z[0],N=W.split(":")[0].trim(),R=W.split(":")[1].trim(),F=b.replace("$","");E.useEffect(()=>{const g=H=>{H.code==="Escape"&&e()};return window.addEventListener("keydown",g),document.body.style.overflow="hidden",()=>{window.removeEventListener("keydown",g),document.body.style.overflow="auto"}},[e]);const _=g=>{g.target===g.currentTarget&&e()};return n.jsx(gt,{onClick:_,children:n.jsxs("div",{className:"modal",children:[n.jsx(ut,{onClick:e,children:"×"}),n.jsx(xt,{children:n.jsx(bt,{src:o||i,alt:a})}),n.jsxs(yt,{children:[n.jsxs(vt,{children:[s," ",n.jsx(wt,{children:p}),","," ",l]}),n.jsxs(jt,{children:[M," | ",m," | Id: ",k," | Year: ",l," | Type:"," ",x," Fuel Consumption: ",j," | Engine Size: ",C]})]}),n.jsx(Ct,{children:a}),n.jsx(kt,{children:"Accessories and functionalities:"}),n.jsxs(Ot,{children:[f[0]," | ",f[1]," | ",f[2]]}),n.jsxs(Pt,{children:[h[0]," | ",h[1]," |",h[2]]}),n.jsx(Mt,{children:n.jsx(zt,{children:"Rental Conditions:"})}),n.jsxs(It,{children:[n.jsxs(u,{children:[N," : ",n.jsx(I,{children:R})]}),n.jsx(u,{children:z[1]}),n.jsx(u,{children:z[2]}),n.jsxs(u,{children:["Mileage: ",n.jsx(I,{children:P.toLocaleString()})]}),n.jsxs(u,{children:["Price: ",n.jsxs(I,{children:[F,"$"]})]})]}),n.jsx(Et,{href:"tel:+380730000000",children:"Rental car"})]})})};export{Dt as B,Bt as C,Nt as M,St as a,Lt as b,At as c,Wt as s};
